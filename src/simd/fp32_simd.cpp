...
VSAG_DEFINE_SIMD_DISPATCH(FP32SparseAccumulate, FP32SparseAccumulateType);
...
VSAG_DEFINE_SIMD_DISPATCH(FP32ComputeIPBatch8, FP32ComputeBatch8Type);
VSAG_DEFINE_SIMD_DISPATCH(FP32ComputeL2SqrBatch8, FP32ComputeBatch8Type);
VSAG_DEFINE_SIMD_DISPATCH(FP32ComputeIPBatch16, FP32ComputeBatch16Type);
VSAG_DEFINE_SIMD_DISPATCH(FP32ComputeL2SqrBatch16, FP32ComputeBatch16Type);
