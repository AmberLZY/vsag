...
public:
    ...
    inline void
    ComputeDistsBatch8(Computer<QuantT>& computer,
                       const uint8_t* codes1,
                       const uint8_t* codes2,
                       const uint8_t* codes3,
                       const uint8_t* codes4,
                       ...
                       float& dists7,
                       float& dists8) const {
        cast().ComputeDistsBatch8Impl(computer,
                                      codes1,
                                      codes2,
                                      codes3,
                                      codes4,
    ...
    inline void
    ComputeDistsBatch16(Computer<QuantT>& computer,
                        const uint8_t* codes1,
                        const uint8_t* codes2,
                        const uint8_t* codes3,
                        const uint8_t* codes4,
                        ...
                        float& dists15,
                        float& dists16) const {
        cast().ComputeDistsBatch16Impl(computer,
                                       codes1,
                                       codes2,
                                       codes3,
                                       codes4,
...
private:
    ...
    GENERATE_HAS_MEMBER_FUNCTION(ComputeDistsBatch4Impl,
                                 ...
                                 std::declval<float&>(),
                                 std::declval<float&>())
    GENERATE_HAS_MEMBER_FUNCTION(ComputeDistsBatch8Impl,
                                 void,
                                 std::declval<Computer<QuantT>&>(),
                                 std::declval<const uint8_t*>(),
                                 std::declval<const uint8_t*>(),
                                 ...
                                 std::declval<float&>(),
                                 std::declval<float&>())
    GENERATE_HAS_MEMBER_FUNCTION(ComputeDistsBatch16Impl,
                                 void,
                                 std::declval<Computer<QuantT>&>(),
                                 std::declval<const uint8_t*>(),
                                 std::declval<const uint8_t*>(),
